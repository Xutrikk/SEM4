...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        using (IRepository repository = Repository.Create("Сelebrities")) // директория (в текущем директории приложения)
        {
            ...
            int? testdel1 = repository.addCelebrity(new Celebrity(3, "TestDel1", "TestDel1", "Photo/TestDel1.jpg"));
            ...
            if (testupd1 != null)
            {
                if (repository.updCelebrityById((int)testupd1, new Celebrity((int)testupd1, "Updated1", "Updated1", "Photo/Updated1.jpg")))
            ...
            if (testupd2 != null)
            {
                if (repository.updCelebrityById((int)testupd2, new Celebrity((int)testupd2, "Updated2", "Updated2", "Photo/Updated2.jpg")))
                    Console.WriteLine($"update {testupd2}");
                else Console.WriteLine($"update {testupd2} error");
            }

            if (repository.updCelebrityById(1000, new Celebrity(1000, "Updated1000", "Updated1000", "Photo/Updated1000.jpg")))
